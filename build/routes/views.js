              ...
              <form action="/register" method="post">
                <div class="sign-up-htm">
                  ...
                  <div class="group">
                    ...
                    <input id="regpass" type="password" name="password" class="input" data-type="password" value="${datas.body && datas.body.password ? datas.body.password : ""}">
                    ${alert("password")}
                  </div>
                  <div class="group">
                    ...
                    <input id="regrepeat" type="password" name="repeat" class="input" data-type="password" value="${datas.body && datas.body.repeat ? datas.body.repeat : ""}">
                    ${alert("repeat")}
                  </div>
                  <div class="group">
