...
exports.default = {
    ...
    locationsHistoricalLocations: {
        ...
        constraints: {
            ...
            location_historical_location_historical_location_id_fkey: 'FOREIGN KEY ("historical_location_id") REFERENCES "historical_location"("id") ON UPDATE CASCADE ON DELETE CASCADE',
    ...
    Datastreams: {
        ...
        columns: {
            ...
            observedArea: {
                create: "geometry NULL",
                comment: "The spatial bounding box of the spatial extent of all FeaturesOfInterest that belong to the Observations associated with this Datastream."
            },
            phenomenonTime: {
                create: "timestamptz NULL",
    ...
    MultiDatastreamObservedproperties: {
        ...
        constraints: {
            multi_datastream_observedproperty_multi_datastream_id_fkey: 'FOREIGN KEY ("multi_datastream_id") REFERENCES "multi_datastream"("id") ON UPDATE CASCADE ON DELETE CASCADE',
            multi_datastream_observedproperty_observedproperty_id_fkey: 'FOREIGN KEY ("observedproperty_id") REFERENCES "observedproperty"("id") ON UPDATE CASCADE ON DELETE CASCADE'
        }
    },
    Observations: {
        name: "Observations",
